...
import openbiomed from "./theme/openbiomed.json" with { type: "json" }
  ...
  init: (props: { mode: "dark" | "light" }) => {
    ...
    setStore(
      produce((draft) => {
        ...
        draft.mode = mode
        draft.lock = lock
        const active = config.theme ?? kv.get("theme", "openbiomed")
        draft.active = typeof active === "string" ? active : "openbiomed"
        draft.ready = false
      }),
    )
